...
<?php
	...
	$edit   = "SELECT pemesanan.id_berangkat, pemesanan.nama, pemesanan.telp, pemesanan.bus, pemesanan.rute,  pemesanan.tgl_pergi, pemesanan.kelas, pemesanan.jumlah, keberangkatan.harga FROM keberangkatan, pemesanan WHERE pemesanan.id = '$id' AND pemesanan.id AND pemesanan.id_berangkat = keberangkatan.id_berangkat";
