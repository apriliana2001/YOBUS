			...
			<table class="table table-striped">
				...
				<tbody>
					<?php
						...
						$query = mysqli_query($conn, "SELECT id_berangkat, nama_bus,  jadwal, rute, kelas, harga FROM keberangkatan")or die(mysqli_error());
          ...
          <div class="modal-body">
            <form action="../config/add_berangkat.php" class="form-horizontal" method="POST">
              <div class="form-group">
                <label class="control-label col-sm-4">Bus :</label>
                  <div class="col-sm-6">
                      <input type="bus" class="form-control" name="bus" placeholder="bus">
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="rute" class="form-control" name="kelas" placeholder="Kelas">
                </div>
              </div>
              <div class="form-group">
